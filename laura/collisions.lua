...
function get_collision_direction(a1, a2)
	...
	if (t < b and t < l and t < r) return 0, -1 --top collision
	if (b < t and b < l and b < r) return 0, -1 --bottom collision
	if (l < r and l < t and l < b) return -1, 0 --left collision
	if (r < l and r < t and r < b) return 1, 0 --right collision
	return 0, 0
end
...
function collide_event(a1, a2)
	if a1.is_player and a2.is_furniture then
		-- search for contact point (backwards)
		local x, y = get_collision_direction(a1, a2)
		while (aabb(a1, a2)) do
			a1.x += x * E
			a1.y += y * E
		end
		...
		debug.s = a1.standing
		debug.p = a1.is_player
	end

	if a1.is_furniture and a2.is_player then
		-- search for contact point (backwards)
		local x, y = get_collision_direction(a1, a2)
		if (x != 0) then
			a1.dx += a2.d * a2.vx
